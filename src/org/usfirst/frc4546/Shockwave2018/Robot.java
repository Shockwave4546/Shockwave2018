...
public class Robot extends TimedRobot {
	...
	Command ArmTest;
	SendableChooser<ArmTest> armChooser = new SendableChooser<>();
    ...
    // Creates camera and video feed
		...
		SmartDashboard.putData("Autonomous Chooser", armChooser);
    ...
    public void teleopPeriodic() {
      ...
      //Toggle Button for Boolean on ShuffleBoard
		...
		FrontRightScale = SmartDashboard.getNumber("FrontR_Scale",0.456);
		BackLeftScale = SmartDashboard.getNumber("BackL_Scale",0.5);
		BackRightScale = SmartDashboard.getNumber("BackR_Scale",0.456);
